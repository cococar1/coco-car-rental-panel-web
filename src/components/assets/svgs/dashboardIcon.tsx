const DashboardIcon = (props: React.SVGProps<SVGSVGElement>): JSX.Element => {
  return (
    <svg
    ...
    >
      ...
      />
      <path d="M12 7L12 12" stroke={props.color ? props.color : "#333333"} />
      <path
        d="M18.3643 9.63574L15.0002 12.9998"
        stroke={props.color ? props.color : "#333333"}
      />
      <path
        d="M5.63574 9.63574L8.99986 12.9999"
        stroke={props.color ? props.color : "#333333"}
      />
    </svg>
  );
